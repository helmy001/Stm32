...
void __attribute__((weak)) DMA1_Channel1_IRQHandler (void) __attribute__((alias ("Default_Handler")));
void __attribute__((weak)) DMA1_Channel2_IRQHandler (void) __attribute__((alias ("Default_Handler")));
void __attribute__((weak)) DMA1_Channel3_IRQHandler (void) __attribute__((alias ("Default_Handler")));
void __attribute__((weak)) DMA1_Channel4_IRQHandler (void) __attribute__((alias ("Default_Handler")));
void __attribute__((weak)) DMA1_Channel5_IRQHandler (void) __attribute__((alias ("Default_Handler")));
void __attribute__((weak)) DMA1_Channel6_IRQHandler (void) __attribute__((alias ("Default_Handler")));
void __attribute__((weak)) DMA1_Channel7_IRQHandler (void) __attribute__((alias ("Default_Handler")));
